...
current_source_code_top_dir=$current_source_code_top_dir/not_in_globle_path/cm_intel_crbox_baytrain_4_4_4_git_list
echo "current_source_code_top_dir=$current_source_code_top_dir"

#############################

#git_admin_config=gitosis.conf
git_admin_config="cm002_intel_baytrain_4_4_4"
android_top_dir="cm_crbox_intel_baytrain_android_4_4_4"
...
if [ -e $git_admin_config ];then
    ...
    do
        ...
        tmp=${tmp_git_name} 
        echo "[group cm_crbox_baytrain_4_4_4_${tmp}_rw_$loop]" >> $git_admin_config
        echo "writable = $android_top_dir/$tmp" >> $git_admin_config
        echo "members = $write_git_source_codei_list" >> $git_admin_config
        echo >> $git_admin_config
        
        echo "[group cm_crbox_baytrain_4_4_4_${tmp}_ro_$loop]" >> $git_admin_config
