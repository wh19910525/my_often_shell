...
############## need modify part ###############
git_admin_config="cm005_xiAn_mtk_6797_dev_board"
android_top_dir_on_git_server_path="xiAn_mtk_6797_dev_board_6_0"
every_sub_dir_list=$current_source_code_top_dir/not_in_globle_path/xiAn_mtk_6797_dev_board_git_list
group_name_prefix=xiAn_mtk_6797_dev_board
