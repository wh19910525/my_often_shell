...
############## need modify part ###############
git_admin_config="001_szkj_public_code_to_git_server_list"
android_top_dir_on_git_server_path="szkj_watch_4_4_4_android_source_code"
every_sub_dir_list=$current_source_code_top_dir/not_in_globle_path/szkj_watch_4_4_4_android_source_code_list
group_name_prefix=szkj_watch_4_4_4_android
