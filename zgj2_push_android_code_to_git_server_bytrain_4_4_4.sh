...
current_source_code_top_dir=`which android_4_4_4_bytrain_git_list`
...
write_git_source_codei_list="wb_git_gly wanghai_157 wanghaifei legang ShuaiNanXiang ChenYinJun DingYuBin LeGang_r yuanhaiping xinkun liuxingde qichaomin zhangjuyuan zjk zhaojingrong laiyuanzhao liuwei huangsheng panyiwen hulin huangjiyu hesl fei_public"
read_git_source_code_list="tanglei buguoliang zhonglongcai chenqi liuzhiqiang xuhaihua"
