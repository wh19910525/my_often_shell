...
android_top_dir=mtk_6797_dev_board_6_0_source_code_$current_data
on_git_server_android_source_code_name=xiAn_mtk_6797_dev_board_6_0
current_source_code_top_dir=$current_source_code_top_dir/not_in_globle_path/xiAn_mtk_6797_dev_board_git_list
...
if [ $Step1 -eq 1 ]; then
    ...
    git clone git@$git_server_addr:public_faddpart/zaddpart_002.git
    echo "$loop : Clone public_faddpart/zaddpart_002.git successed!!"
    ############### get public code end ################
