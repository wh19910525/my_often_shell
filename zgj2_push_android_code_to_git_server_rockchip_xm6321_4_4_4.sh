...
write_git_source_codei_list="wb_git_gly wanghai_157 wanghaifei legang ShuaiNanXiang ChenYinJun DingYuBin LeGang_r yuanhaiping xinkun liuxingde qichaomin zhangjuyuan zjk zhaojingrong laiyuanzhao liuwei huangsheng panyiwen hulin"
#write_git_source_codei_list="wb_git_gly@pbserver wanghai_157 qichaomin huangsheng panyiwen liuwei liuxingde hulin"
read_git_source_code_list="tanglei zhonglongcai chenqi"
