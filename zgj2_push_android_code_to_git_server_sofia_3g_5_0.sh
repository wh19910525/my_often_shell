...
loop=1
current_path=`pwd`
current_source_code_top_dir=`which zgj2_push_android_code_to_git_server_sofia_3g_5_0.sh`
current_source_code_top_dir=${current_source_code_top_dir%/*}
echo "current_source_code_top_dir=$current_source_code_top_dir"
manifest_file_path=$current_source_code_top_dir/not_in_globle_path/sofia_3g_manifest/sofia_3g_5_0_git_list
echo "manifest_file_path=$manifest_file_path"

#############################

#git_admin_config=gitosis.conf
git_admin_config="007_intel_sofia_3g_5_0.txt"
...
if [ -e $git_admin_config ];then
    ...
    do
        ...
        echo "[group sofia_3g_5_0_${modify_tmp}_rw_$loop]" >> $git_admin_config
        echo "writable = $android_top_dir/$tmp" >> $git_admin_config
        echo "members = $write_git_source_codei_list" >> $git_admin_config
        echo >> $git_admin_config
        
        echo "[group sofia_3g_5_0_${modify_tmp}_ro_$loop]" >> $git_admin_config
