...
android_top_dir=baytrain_4_4_4_new_tablet_source_code_$current_data
on_git_server_android_source_code_name=cm_tablet_intel_baytrain_android_4_4_4_new
current_source_code_top_dir=$current_source_code_top_dir/not_in_globle_path/cm_intel_new_tablet_baytrain_4_4_4_git_list
