...
############## need modify part ###############
git_admin_config="cm004_intel_Cherrytrail_T3_5_1"
android_top_dir_on_git_server_path="cm_Cherrytrail_T3_android_5_1"
every_sub_dir_list=$current_source_code_top_dir/not_in_globle_path/cm_Cherrytrail_T3_android_5_1_git_list
group_name_prefix=cm_Cherrytrail_T3_android_5_1
