...
############## need modify part ###############
git_admin_config="cm003_intel_baytrain_4_4_4"
android_top_dir_on_git_server_path="cm_tablet_intel_baytrain_android_4_4_4_new"
every_sub_dir_list=$current_source_code_top_dir/not_in_globle_path/cm_intel_new_tablet_baytrain_4_4_4_git_list
group_name_prefix=intel_baytrain_4_4_4_new_tablet
