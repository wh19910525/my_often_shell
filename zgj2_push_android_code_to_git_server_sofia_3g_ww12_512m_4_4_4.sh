...
current_source_code_top_dir=$current_source_code_top_dir/not_in_globle_path/sofia_3g_w12_512m_4_4_4_git_list
echo "current_source_code_top_dir=$current_source_code_top_dir"

#############################

#git_admin_config=gitosis.conf
git_admin_config="009_intel_sofia_3g_w12_512m_4_4_4.txt"
android_top_dir="intel_sofia_3g_w12_512m_4_4_4"
...
if [ -e $git_admin_config ];then
    ...
    do
        ...
        tmp=${tmp_git_name} 
        echo "[group sofia_3g_w12_512m_${tmp}_rw_$loop]" >> $git_admin_config
        echo "writable = $android_top_dir/$tmp" >> $git_admin_config
        echo "members = $write_git_source_codei_list" >> $git_admin_config
        echo >> $git_admin_config
        
        echo "[group sofia_3g_w12_512m_${tmp}_ro_$loop]" >> $git_admin_config
