...
############## need modify part ###############
git_admin_config="001_public_code_to_git_server_list"
android_top_dir_on_git_server_path="public_faddpart"
every_sub_dir_list=$current_source_code_top_dir/not_in_globle_path/public_code_to_git_server_list
group_name_prefix=public_part_for_every_aosp
